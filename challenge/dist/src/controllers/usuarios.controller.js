    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, user_model_1.UserModel.findByIdAndUpdate(id, resto)];
            case 2:
                respMongoDb = _b.sent();
                return [2 /*return*/, res.status(200).json({
                        ok: true,
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                usuario = new user_model_1.UserModel(__assign(__assign({}, rest), { password: password, correo: correo }));
                _b.label = 1;
            case 1:
                _b.trys.push([1, 3, , 4]);
                salt = bcryptjs_1.default.genSaltSync();
