...
router.put("/:id", [(0, express_validator_1.check)("id", "No es ID valido").isMongoId(), (0, express_validator_1.check)("id").custom(function (item) { return (0, db_validators_1.existeUsuarioId)(item); }), middlewares_1.validarCampos], usuarios_controller_1.usuarioPut);
